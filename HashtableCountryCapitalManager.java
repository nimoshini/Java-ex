...
public class HashtableCountryCapitalManager {
    private Hashtable<String, String> M1 = new Hashtable<>();

    // Method to add country and capital to the Hashtable
    ...
    public static void main(String[] args) {
        HashtableCountryCapitalManager manager = new HashtableCountryCapitalManager();
